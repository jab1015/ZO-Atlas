      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-2 text-center">
            <h1 className="text-2xl font-bold text-foreground" style={{ fontFamily: "var(--font-heading), ui-sans-serif, system-ui, sans-serif" }}>
              {code ? "Choose a new password" : "Reset your password"}
            </h1>
            <p className="text-sm text-muted-foreground">{code ? "Set a new password to return to your invention workspace." : "Enter your email and we’ll send you a secure reset link."}</p>
          </div>
          {code ? (
          ...
          <p className="text-center text-sm text-muted-foreground"><Link href="/sign-in" className="font-medium text-foreground underline-offset-4 hover:underline">Back to sign in</Link></p>
        </div>
      </div>
      <MadeThisBadge />
    </div>
